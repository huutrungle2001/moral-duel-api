...
from .utils import print_section, print_success, print_error, print_info, Colors
...
def run_all_tests():
    ...
    try:
        ...
        from .test_auth import run_all_tests as test_auth
    ...
    try:
        ...
        from .test_cases import run_all_tests as test_cases
        test_cases()
        results["cases"] = True
    except Exception as e:
    ...
    try:
        ...
        from .test_arguments import run_all_tests as test_arguments
        test_arguments()
    ...
    print(f"\n{Colors.BOLD}Note:{Colors.END} Make sure the API server is running: make dev")
    print()
